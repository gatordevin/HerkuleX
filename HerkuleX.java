...
public class HerkuleX {
    ...
    public void initialize() {
        try {
            ...
            Thread.sleep(10);
            System.out.println("Ack Policy Set");
            torqueON(BROADCAST_ID);		// torqueON for all servos
            Thread.sleep(10);
            System.out.println("Torque On");
     ...
     */
    public ArrayList<Integer> performIDScan() throws IOException {
        mIDs.clear();
     ...
     * Value(+)]
     */
    public int getSpeed(int servoID) throws IOException {
     ...
     * @example HerkuleX_Pos_Ctrl
     */
    public int getPosition(int servoID) throws IOException {
        if ((byte) servoID == 0xFE) {
            return -1;
        }
     ...
     */
    public float getAngle(int servoID) throws IOException {
     ...
     */
    public byte stat(int servoID) throws IOException {
        if ((byte) servoID == 0xFE) {
            return 0x00;
        }
     ...
     */
    public byte model(int servoID) throws IOException {
        byte[] optData = new byte[2];
     ...
     *
     */
    public boolean set_ID(int ID_Old, int ID_New) throws IOException {
